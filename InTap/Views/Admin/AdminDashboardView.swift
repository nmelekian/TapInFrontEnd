...
struct AdminDashboardView: View {
    ...
    var body: some View {
        ScrollView {
            ...
            HStack {
                AdminDashCardView(isShowing: $isShowingCompletionPage, resultsOrCompletion: completion, rating: 83)
                .sheet(isPresented: $isShowingCompletionPage) {
                    TapInCompletionView()
                        .presentationDetents([.fraction(0.5)])
                }
                AdminDashCardView(isShowing: $isShowingResultsPage, resultsOrCompletion: results, rating: 90)
